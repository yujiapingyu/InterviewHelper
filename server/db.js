      ...
      const defaultQuestions = [
        {
          ...
          question_zh: '请做个自我介绍。',
          model_answer_ja: '【Point】私は〇〇大学を卒業後、5年間ソフトウェア開発の仕事に携わってきました。\n\n【Reason】人とコミュニケーションを取りながら、問題を解決することにやりがいを感じています。前職では、チームメンバーと協力しながらプロジェクトを成功させることができました。\n\n【Example】特に印象に残っているのは、納期が厳しいプロジェクトでチームリーダーと密に連携し、優先順位を明確にすることで、期限内に高品質な成果物を納品できたことです。\n\n【Point】貴社でも、チームの一員として貢献し、成長していきたいと考えています。',
        ...
        },
        {
          ...
          model_answer_ja: '【Point】日本の仕事に対する真摯な姿勢と、チームワークを大切にする文化に魅力を感じています。\n\n【Reason】私は協調性を重視しており、日本の「報連相」の文化や、細部まで丁寧に仕事を進めるスタイルが自分の価値観と合っていると感じています。\n\n【Example】以前、日本人の同僚と一緒に仕事をした際、彼らの計画性と責任感の強さに感銘を受けました。その経験から、日本で長期的にキャリアを築きたいと思うようになりました。\n\n【Point】貴社で日本のビジネス文化を学びながら、自分も成長していきたいと考えています。',
        ...
        },
        {
          ...
          model_answer_ja: '【Point】私の長所は、責任感が強く、最後までやり遂げる力があることです。\n\n【Reason】一度引き受けた仕事は、困難があっても諦めずに解決策を探し、必ず完成させるよう心がけています。\n\n【Example】前職では、予期せぬ問題が発生したプロジェクトで、残業や休日出勤も厭わず対応し、最終的にお客様から高い評価をいただきました。\n\n【Point】一方、短所は完璧主義なところで、時に時間をかけすぎてしまうことがあります。現在は、優先順位をつけて効率的に仕事を進めるよう意識して改善に取り組んでいます。',
        ...
        },
        {
          ...
          model_answer_ja: '【Point】5年後には、チームリーダーとして後輩を指導できる立場になりたいと考えています。\n\n【Reason】技術力を高めるだけでなく、マネジメントスキルやコミュニケーション能力も磨き、チーム全体の生産性を高められる人材になりたいからです。\n\n【Example】そのために、現在はプロジェクト管理の勉強を始めており、小規模なプロジェクトでリーダー経験を積んでいます。\n\n【Point】10年後には、部門を統括するマネージャーとして、会社の成長に貢献できる存在になりたいと考えています。貴社で長期的にキャリアを積み、共に成長していきたいです。',
